clear; clc; close all;
addpath '/autofs/eris/purdongp/users/pavitrak/sourceloc_data/AEP/manny/meas/abr_plr_runall'; 
addpath '/autofs/eris/purdongp/users/pavitrak/sourceloc_data/AEP/manny/meas/abr_plr_calibration'; 
covs = 0; hfabr = 1;

%% Average Measurement Files
raw_fname = 'eyesopen_raw.fif';
...
selname = strcat(selpath, 'manny.sel');
...
%str = {'Right-temporal','Left-temporal','Right-parietal','Left-parietal','Right-occipital','Left-occipital','Right-frontal','Left-frontal'};
cnt = 1;
for ss = 1:length(str)
    selstr = str{ss}; 
...
abrssp_fname  = 'emptyroom_ABR_SSP.fif';
end
if mlr == 1
...
if megcov == 1
    ...
    a = eegpicks -317; a = [a(1:58) a(59:70)-4];
