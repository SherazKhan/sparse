...
manny_measinfo_megeeg(prefix, datatype, meastype, datapath, plot_on, append, saveon);%Derive whitener and noise covariances - for use in srcfwd and inv solns
