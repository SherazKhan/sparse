...
if fullcort == 0
    scort_resfname = strcat(pwd,'/Final_',append(2:end),'_hip-',hfwd_type,'/', prefix,'-',meastype,'-',datatype,'_scortest',append,'.mat');       % subcortical results
else
    scort_resfname = strcat(pwd,'/Final_',append(2:end),'_hip-',hfwd_type,'/', prefix,'-',meastype,'-',datatype,'_1stage_scortest',append,'.mat');% subcortical results
end
