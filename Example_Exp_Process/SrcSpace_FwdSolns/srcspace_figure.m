...
load(strcat(dpath,'/fwd/',prefix,'_subc_',meastype,'_plr-prewhite_volumes',add_on_name,append,'.mat'));     
...
for i = 2:2
 ...
 for sreg = 1:length(sreg_case)
  ...
  for j = 1:length(ssubdiv)
    ...
    A = MRIread(strcat(dpath,'/mri/svolume_decomps/',append(2:end),'/', maskname)); 
