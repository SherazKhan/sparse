...
load('sregcode.mat', 'region', 'reg_code','code');
...
load(strcat(datapath,'/mri/T3.mat')); 	%T3 = [1 0 0 -4.02; 0 1 0 16.99; 0 0 1 9.83; 0 0 0 1];
...
for i = 1:length(tregion)
    ...
    if strcmp(tregion{i}, 'brainstem')
      ...
      %[srclocs, ndipoles, volume, pick_inds] = reduce_brainstem_splits(srclocs_bsfull, ndipoles, ...
      ...
      pause; %check pick_inds dimension
