...
load(strcat(datapath, '/fwd/', prefix,'_subc_',meastype,'_prewhite','_SVDs',add_on_name,append,'.mat'),'sdiv_fwd'); 
whitened_svd = sdiv_fwd; clear sdiv_fwd;
load(strcat(datapath,'/fwd/',prefix,'_subc_',meastype,'_prewhite_volumes',add_on_name,append,'.mat'));
