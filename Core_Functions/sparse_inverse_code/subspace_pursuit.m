function [iiter,Lp,trimP,Xtrim] = subspace_pursuit(alg,C,Gn,Gtheta,L,N,p,patchno,subdiv,stop,t1,t2,u,Y,dub,SNR,currstr)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
while isequal(flag,0)
    ...
    if  isequal(count,1)
        ...
        trimX{count} = IX{count}(1,IND2(1:Lp));
...
%figure, set(gcf,'color','white'); plot(E);
%pause; close all;
end