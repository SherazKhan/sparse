function [Xls_plot_modes, Xls_plot] = backproj_mne(lk, clkmax, trimP, strimP, ctrimP, reg_index, svolume, cpatch,...
         sdiv_fwd_plot, ico, Xls_scaled, currstr, hsrc, hfwd, csrc)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Project scaled estimates from eigenspace to physical space for plotting MNE estimates
...
for i = 1:length(trimP)
  ...
  if s > 0                                                  
    ...
    Vs = sdiv.whiteVs(:,mode_num);                                          % right eigenvector for chosen mode - num_dipoles X
